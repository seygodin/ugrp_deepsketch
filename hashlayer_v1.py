...
fileprefix = "model/model_hash_{}_{}_{}_{}_{}_{}".format(tag, _hashSize, _denseSize1, _denseSize2, _which_dense, _lr,
                                                         _alpha)
...
class RevisedNetwork(torch.nn.Module):
    def __init__(self):
        ...
        self.conv_layers.append(
            nn.Conv1d(in_channels=32, out_channels=16, kernel_size=3, stride=1, padding=1, bias=True))
        self.conv_layers.append(nn.ReLU())
